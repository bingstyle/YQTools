...
+ (NSString *)yq_platformString{
    NSString *platform = [self yq_platform];
...
+ (NSUInteger)yq_getSysInfo:(uint)typeSpecifier
{
...
+ (NSUInteger)yq_cpuFrequency {
    return [self yq_getSysInfo:HW_CPU_FREQ];
}

+ (NSUInteger)yq_busFrequency {
    return [self yq_getSysInfo:HW_BUS_FREQ];
}

+ (NSUInteger)yq_ramSize {
    return [self yq_getSysInfo:HW_MEMSIZE];
}

+ (NSUInteger)yq_cpuNumber {
    return [self yq_getSysInfo:HW_NCPU];
}


+ (NSUInteger)yq_totalMemoryBytes
{
    return [self yq_getSysInfo:HW_PHYSMEM];
}
