...
@implementation NSData (Encrypt_yq)

static void yq_FixKeyLengths(CCAlgorithm algorithm, NSMutableData * keyData, NSMutableData * ivData)
{
...
- (NSData*)yq_encryptedWithAESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self yq_CCCryptData:self algorithm:kCCAlgorithmAES128 operation:kCCEncrypt key:key iv:iv];
}
/**
 *  @brief  利用AES解密据
 *
...
- (NSData*)yq_decryptedWithAESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self yq_CCCryptData:self algorithm:kCCAlgorithmAES128 operation:kCCDecrypt key:key iv:iv];
}
/**
 *  利用3DES加密数据
 *
...
- (NSData*)yq_encryptedWith3DESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self yq_CCCryptData:self algorithm:kCCAlgorithm3DES operation:kCCEncrypt key:key iv:iv];
}
/**
 *  @brief   利用3DES解密数据
 *
...
- (NSData*)yq_decryptedWith3DESUsingKey:(NSString*)key andIV:(NSData*)iv {
    return [self yq_CCCryptData:self algorithm:kCCAlgorithm3DES operation:kCCDecrypt key:key iv:iv];
}
...
- (NSData *)yq_encryptedWithDESUsingKey:(NSString*)key andIV:(NSData*)iv{
    return [self yq_CCCryptData:self algorithm:kCCAlgorithmDES operation:kCCEncrypt key:key iv:iv];
}
/**
 *  @brief   利用DES解密数据
 *
...
- (NSData *)yq_decryptedWithDESUsingKey:(NSString*)key andIV:(NSData*)iv{
    return [self yq_CCCryptData:self algorithm:kCCAlgorithmDES operation:kCCDecrypt key:key iv:iv];
}
- (NSData *)yq_CCCryptData:(NSData *)data
    ...
    yq_FixKeyLengths(algorithm, keyData,ivData);
